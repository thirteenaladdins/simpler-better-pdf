...
class Siemens:
    ...
    def extract_siemens(path_to_pdf):
        """
        Extract data from a Siemens PDF.
        """
        with fitz.open(stream=path_to_pdf, filetype="pdf") as doc:
        ...
        df = pd.DataFrame(full_list, columns=["commodity code", "description", "quantity", "gross weight", "net weight", "value"])
        df["country of origin"] = ""
        df["invoice"] = ""
        df["shipment"] = ""
...
#     df = Siemens.extract_siemens(path_to_pdf)
#     print(df)